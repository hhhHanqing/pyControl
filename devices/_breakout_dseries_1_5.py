...
# for use with pyControl D-Series Breakout PCB v1.5
# for more info visit https://karpova-lab.github.io/pyControl-D-Series-Breakout/#pinout

class Breakout_dseries_1_5(_h.Mainboard):
    def __init__(self):
        # Inputs and outputs.
        self.port_1 =  _h.Port(DIO_A='W53', DIO_B='W57', POW_A='W16', POW_B='W50', DIO_C='W61')
        self.port_2 =  _h.Port(DIO_A='W47', DIO_B='W49', POW_A='W60', POW_B='W22', DIO_C='W51')
